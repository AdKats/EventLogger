...
namespace PRoConEvents
{
    public class EventLogger : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        */
        ...
        private Int32 SettingAdkatsSyncTime;
...
";
        ...
        {
            Boolean layerReady = (((DateTime.UtcNow - this.LayerStartingTime).TotalSeconds) > 60);
            if (this.SettingLocked == enumBoolYesNo.Yes)
            {
            ...
            {
                Int32 tmpSyncBan = 1;
                Int32.TryParse(strValue, out tmpSyncBan);
        ...
        {
            Int32 tmp_days = Minutes / 1440;
            Int32 tmp_hours = (Minutes - (tmp_days * 1440)) / 60;
